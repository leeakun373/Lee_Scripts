--[[
  ...
  Description: Modular marker management tool
  - Dynamically loads marker functions from MarkerFunctions directory
  - Provides unified GUI interface for all marker operations
