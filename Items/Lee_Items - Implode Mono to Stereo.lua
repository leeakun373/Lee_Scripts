--[[
  REAPER Lua Script: Implode Mono Items into Stereo Item
  Based on: rodilab_Implode mono items into stereo item.lua
  Original Author: Rodrigo Diaz (aka Rodilab)
...
local function main ()
  ...
  if count > 1 then
    ...
    reaper.Undo_EndBlock("Implode mono items into stereo item",-1)
    reaper.PreventUIRefresh(-1)
